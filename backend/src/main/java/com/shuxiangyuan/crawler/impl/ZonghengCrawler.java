    ...
    protected List<NovelInfo> getMockData() {
        return List.of(
            ...
            NovelInfo.builder()
                ...
                .title("元尊")
                .author("天蚕土豆")
                .description("天地为炉，万物为铜，阴阳为炭，造化为工。")
                .sourceUrl("https://www.zongheng.com/book/456789")
                .status("完结")
                .totalChapters(1500)
                .build(),
            NovelInfo.builder()
                ...
                .title("圣墟")
                .author("辰东")
                .description("在旷野中，在高原上，在废墟间。")
                .sourceUrl("https://www.zongheng.com/book/567890")
                .status("连载")
                .totalChapters(1800)
                .build(),
            NovelInfo.builder()
                ...
                .title("武极天下")
                .author("默默")
                .description("武道通神，武道破空。")
                .sourceUrl("https://www.zongheng.com/book/678901")
                .status("完结")
                .totalChapters(2200)
                .build(),
            NovelInfo.builder()
                ...
                .title("大主宰")
                .author("天蚕土豆")
                .description("大千世界，位面交汇，万族林立。")
                .sourceUrl("https://www.zongheng.com/book/789012")
                .status("完结")
                .totalChapters(1600)
                .build(),
            NovelInfo.builder()
                ...
                .title("龙符")
                .author("梦入神机")
                .description("苍茫大地，万族争锋。")
                .sourceUrl("https://www.zongheng.com/book/890123")
                .status("完结")
                .totalChapters(1900)
                .build(),
            NovelInfo.builder()
                ...
                .author("横扫天涯")
                .description("武道通神，武道破空。")
                .sourceUrl("https://www.zongheng.com/book/901234")
                .status("连载")
                .totalChapters(1100)
                .build(),
            NovelInfo.builder()
                ...
                .title("武道霸主")
                .author("念念")
                .description("武道巅峰，谁与争锋。")
                .sourceUrl("https://www.zongheng.com/book/012345")
                .status("连载")
                .totalChapters(800)
                .build()
        );
