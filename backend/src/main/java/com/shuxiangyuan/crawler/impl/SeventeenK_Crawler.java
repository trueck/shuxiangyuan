 ...
 */
@Component
public class SeventeenK_Crawler extends AbstractCrawler {

    private static final String BASE_URL = "https://www.17k.com";
    private static final String RANK_BASE_URL = "https://www.17k.com/rank";
    ...
    protected String buildRankingUrl(String rankingType) {
        return switch (rankingType) {
            ...
            default -> throw new IllegalArgumentException("17K小说网不支持的排行榜类型: " + rankingType);
        };
    }
    ...
    protected List<NovelInfo> parseRankingDocument(Document doc) {
        ...
        try {
            ...
            log.debug("17K找到 {} 个排行榜条目", rankItems.size());
